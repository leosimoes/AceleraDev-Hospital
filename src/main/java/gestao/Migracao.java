...
//        String[] nomeHospital = {"Hospital Getúlio Vargas Filho", "Fundação Municipal de Saúde", "Instituto Nacional do Câncer ", "Hospital Sao Paulo", "Hospital de Caridade Dr. Astrogildo de Azevedo"};
